...
- [docs/THEME.md](docs/THEME.md) — retro sci-fi theming system: six themes (Apollo / Nostromo / Vectrex / Blade Runner / LCARS / Section 9), MQTT contract, asset authoring rules (FR-15).
